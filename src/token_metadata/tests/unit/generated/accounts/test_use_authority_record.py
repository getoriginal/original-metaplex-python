...
from src.token_metadata.generated.accounts.use_authority_record import (
    PROGRAM_ID,
    UseAuthorityRecord,
)
...
async def test_use_authority_record_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.use_authority_record.get_multiple_accounts",
...
def test_use_authority_record_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.use_authority_record.UseAuthorityRecord.layout.parse",
