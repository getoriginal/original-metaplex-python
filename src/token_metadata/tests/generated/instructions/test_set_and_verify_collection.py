...
from src.token_metadata.generated.instructions import set_and_verify_collection
from src.token_metadata.generated.program_id import PROGRAM_ID


def test_set_and_verify_collection():
    accounts = {
