...
from src.token_metadata.generated.accounts.master_edition_v1 import (
    PROGRAM_ID,
    MasterEditionV1,
)
...
async def test_master_edition_v1_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.master_edition_v1.get_multiple_accounts",
...
def test_master_edition_v1_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.master_edition_v1.MasterEditionV1.layout.parse",
