...
from src.token_metadata.generated.accounts.token_record import PROGRAM_ID, TokenRecord
from src.token_metadata.generated.types.key import KeyKind
from src.token_metadata.generated.types.key import TokenRecord as TokenRecordKey
from src.token_metadata.generated.types.token_delegate_role import (
    TokenDelegateRoleKind,
    Transfer,
)
from src.token_metadata.generated.types.token_state import TokenStateKind, Unlocked
...
async def test_token_record_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.token_record.get_multiple_accounts",
...
def test_token_record_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.token_record.TokenRecord.layout.parse",
