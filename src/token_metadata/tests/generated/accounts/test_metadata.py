...
from src.token_metadata.generated.accounts.metadata import PROGRAM_ID, Metadata
from src.token_metadata.generated.types import Creator
from src.token_metadata.generated.types.data import Data
from src.token_metadata.generated.types.key import KeyKind
from src.token_metadata.generated.types.key import MetadataV1 as MetadataV1Key
...
async def test_metadata_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.metadata.get_multiple_accounts",
...
def test_metadata_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "src.token_metadata.generated.accounts.metadata.Metadata.layout.parse",
