...
from original_metaplex_python.token_metadata.generated.instructions import unverify
...
def test_unverify():
    args = {"verification_args": CreatorV1()}
    accounts = {
...
def test_unverify_with_remaining_accounts():
    ...
    instruction = unverify(args, accounts, remaining_accounts=remaining_accounts)
