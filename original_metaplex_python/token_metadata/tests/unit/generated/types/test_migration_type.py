from original_metaplex_python.token_metadata.generated.types import migration_type
from original_metaplex_python.token_metadata.generated.types.migration_type import (
    CollectionV1,
    ProgrammableV1,
)
