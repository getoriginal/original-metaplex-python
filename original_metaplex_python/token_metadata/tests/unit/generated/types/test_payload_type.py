...
from original_metaplex_python.token_metadata.generated.types.payload_type import (
    MerkleProof,
    Number,
    PubkeyPayload,
    Seeds,
...
from original_metaplex_python.token_metadata.generated.types.proof_info import ProofInfo
