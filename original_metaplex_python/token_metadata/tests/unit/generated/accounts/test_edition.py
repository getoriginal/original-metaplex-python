...
from original_metaplex_python.token_metadata.generated.accounts.edition import (
    PROGRAM_ID,
    Edition,
)
from original_metaplex_python.token_metadata.generated.types.key import (
    EditionV1 as EditionKey,
)
...
async def test_edition_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.edition.get_multiple_accounts",
...
def test_edition_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.edition.Edition.layout.parse",
