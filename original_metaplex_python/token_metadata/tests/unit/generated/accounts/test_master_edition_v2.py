...
from original_metaplex_python.token_metadata.generated.accounts.master_edition_v2 import (
    PROGRAM_ID,
    MasterEditionV2,
)
...
async def test_master_edition_v2_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.master_edition_v2.get_multiple_accounts",
...
def test_master_edition_v2_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.master_edition_v2.MasterEditionV2.layout.parse",
