...
from original_metaplex_python.token_metadata.generated.accounts.edition_marker import (
    PROGRAM_ID,
    EditionMarker,
)
from original_metaplex_python.token_metadata.generated.types.key import (
    EditionMarker as EditionMarkerKey,
)
...
async def test_edition_marker_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.edition_marker.get_multiple_accounts",
...
def test_edition_marker_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.edition_marker.EditionMarker.layout.parse",
