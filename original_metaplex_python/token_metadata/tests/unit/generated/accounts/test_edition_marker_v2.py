...
from original_metaplex_python.token_metadata.generated.accounts.edition_marker_v2 import (
    PROGRAM_ID,
    EditionMarkerV2,
)
from original_metaplex_python.token_metadata.generated.types.key import (
    EditionMarkerV2 as EditionMarkerV2Key,
)
...
async def test_edition_marker_v2_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.edition_marker_v2.get_multiple_accounts",
...
def test_edition_marker_v2_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.edition_marker_v2.EditionMarkerV2.layout.parse",
