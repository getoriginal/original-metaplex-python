...
from original_metaplex_python.token_metadata.generated.accounts.token_owned_escrow import (
    PROGRAM_ID,
    TokenOwnedEscrow,
)
...
async def test_token_owned_escrow_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.token_owned_escrow.get_multiple_accounts",
...
def test_token_owned_escrow_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.token_owned_escrow.TokenOwnedEscrow.layout.parse",
