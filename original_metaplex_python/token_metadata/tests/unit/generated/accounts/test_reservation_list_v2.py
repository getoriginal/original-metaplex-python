...
from original_metaplex_python.token_metadata.generated.accounts.reservation_list_v2 import (
    PROGRAM_ID,
    ReservationListV2,
)
...
from original_metaplex_python.token_metadata.generated.types.reservation import (
    Reservation,
)
...
async def test_reservation_list_v2_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.reservation_list_v2.get_multiple_accounts",
...
def test_reservation_list_v2_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.reservation_list_v2.ReservationListV2.layout.parse",
