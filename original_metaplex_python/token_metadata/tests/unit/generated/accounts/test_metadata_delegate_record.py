...
from original_metaplex_python.token_metadata.generated.accounts.metadata_delegate_record import (
    PROGRAM_ID,
...
async def test_metadata_delegate_record_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.metadata_delegate_record.get_multiple_accounts",
...
def test_metadata_delegate_record_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.metadata_delegate_record.MetadataDelegateRecord.layout.parse",
