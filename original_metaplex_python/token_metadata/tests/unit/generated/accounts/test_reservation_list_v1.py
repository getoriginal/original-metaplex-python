...
from original_metaplex_python.token_metadata.generated.accounts.reservation_list_v1 import (
    PROGRAM_ID,
    ReservationListV1,
)
...
async def test_reservation_list_v1_fetch_multiple_success(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.reservation_list_v1.get_multiple_accounts",
...
def test_reservation_list_v1_decode(mocker: MockerFixture):
    ...
    mocker.patch(
        "original_metaplex_python.token_metadata.generated.accounts.reservation_list_v1.ReservationListV1.layout.parse",
